...
if (NOT DEFINED B3D_UTILS_DIR)
    set(B3D_UTILS_DIR ${CMAKE_CURRENT_LIST_DIR})
    message(WARNING "B3D_UTILS_DIR is not defined, current using: ${B3D_UTILS_DIR}")
endif()

### Configure: B3D_UTILS_INC_DIRS, B3D_UTILS_LIB_DIRS, B3D_UTILS_LIBS
set(B3D_UTILS_INC_DIRS "${B3D_UTILS_DIR}/include")

set(B3D_UTILS_LIB_DIRS "${B3D_UTILS_DIR}/lib/$<CONFIGURATION>/")

set(B3D_UTILS_LIBS b3dutils)
...
#
#     set(B3D4_CLIENT_LIB b3d4client)
# elseif(WIN32)
...
# endif()
#
# # # TODO: should include b3d_depth?
# # set(B3D_CAMERA_LIBS b3dcamera )
