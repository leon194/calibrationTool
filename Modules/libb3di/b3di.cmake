...
# endif()
# set(USE_ECXT 1)
# TODO: Above settings should be turned into CMake build options
...
set(B3DI_INC_DIRS ${B3DI_INC} ${TRIMESH2_INC})

if(ANDROID)
    set(B3DI_OPENCV_LIBS opencv_java3)
else()
...
# set(B3DI_3RDPARTY_LIBS stasm trimesh2 linear sha256 eyeLike polypartition cppdes facepp)
