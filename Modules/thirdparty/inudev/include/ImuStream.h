...
* This file is part of the Inuitive SDK
*
* Copyright (C) 2014 All rights reserved to   
*
*/
...
namespace InuDev 
{
    ...
    struct CImuFrame : public CBaseFrame
    {
        ...
        bool GetSensorData(EImuType etype, CPoint3D& point)
        {
            if (SensorsData.find(etype) != SensorsData.end())
            {
                point = SensorsData[etype];
                return true;
            }
            return false;
        }
    ...
    /// \brief    Represents Temperature in celcius provided by IMU device. 
    struct CImuTemperatureParams
    {
        float mTemperature;
        CImuTemperatureParams() {}
        CImuTemperatureParams(float tmpr) : mTemperature(tmpr) {}
    };
    ...
    struct CIioChannelInfo
   {
    ...
    /// 
    ////////////////////////////////////////////////////////////////////////
    class CImuStream : public CBaseStream
    {
    public:
