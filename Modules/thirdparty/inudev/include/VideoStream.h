...
namespace InuDev 
{
    ...
    public:
        ...
        typedef std::function<void(std::shared_ptr<CVideoStream>, std::shared_ptr<const CVideoFrame>,  CInuError)> CallbackFunction;
        ...
        /// \param[in] iInterleaved    Acquire video frame as interleaved. default is set to false.
        /// \param[in] EOutputType     Acquire video output format. default is set according to FW
        ...
        virtual CInuError GetFrame(std::shared_ptr<const CVideoFrame>& oVideoFrame, unsigned int iTimeout = FPS_BASED_TIMEOUT) = 0;
